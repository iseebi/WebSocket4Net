...
set outDir=bin\xamarinios10\Debug
%msbuild% WebSocket4Net.Xamarin.iOS\WebSocket4Net.Xamarin.iOS.csproj /p:OutDir=..\%outDir%;Configuration=Debug /t:Clean;Rebuild
...
set outDir=bin\xamarinios10\Release
%msbuild% WebSocket4Net.Xamarin.iOS\WebSocket4Net.Xamarin.iOS.csproj /p:OutDir=..\%outDir%;Configuration=Release /t:Clean;Rebuild
FOR /F "tokens=*" %%G IN ('DIR /B /AD /S obj') DO RMDIR /S /Q "%%G"
